...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_underscore, spawn,          SHCMD("${HOME}/.local/bin/audio sink --minus10") },
	{ MODKEY,                    XKB_KEY_equal,      spawn,          SHCMD("${HOME}/.local/bin/audio sink --plus") },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_plus,       spawn,          SHCMD("${HOME}/.local/bin/audio sink --plus10") },
	{ MODKEY,                    XKB_KEY_BackSpace,  spawn,          SHCMD("${HOME}/.local/bin/audio sink --mute") },
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_minus,      spawn,          SHCMD("${HOME}/.local/bin/audio source --minus") },
	{ MODKEY|WLR_MODIFIER_CTRL|WLR_MODIFIER_SHIFT,XKB_KEY_underscore,spawn,SHCMD("${HOME}/.local/bin/audio source --minus10") },
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_equal,      spawn,          SHCMD("${HOME}/.local/bin/audio source --plus") },
	{ MODKEY|WLR_MODIFIER_CTRL|WLR_MODIFIER_SHIFT,XKB_KEY_plus,spawn,SHCMD("${HOME}/.local/bin/audio source --plus10") },
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_braceleft,  spawn,          SHCMD("${HOME}/.local/bin/bright --minus10") },
	{ MODKEY,                    XKB_KEY_bracketright,spawn,         SHCMD("${HOME}/.local/bin/bright --plus") },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_braceright, spawn,          SHCMD("${HOME}/.local/bin/bright --plus10") },
	...
	{ MODKEY,                    XKB_KEY_g,          spawn,          SHCMD("${HOME}/.local/bin/shoot") },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_G,          spawn,          SHCMD("${HOME}/.local/bin/shoot --geo") },
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_g,          spawn,          SHCMD("${HOME}/.local/bin/shoot --all") },
